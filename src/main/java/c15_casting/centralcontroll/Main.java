...
public class Main {
    public static void main(String[] args) {
        ...
        // centralControl.displayInfo()를 실행했을 때 콘솔창에 현재 배열에 들어가 있는 요소들을 출력할 수 있도록 코드를 작성하시오.
...
//        centralControll.powerOn();
//        centralControll.powerOff();

//        centralControll.displayInfo2();
