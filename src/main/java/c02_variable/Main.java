...
//        System.out.println("" + name1 + name2 + name3); // java의 sout의 경우 맨 앞의 자료형을 따라감
        ...
        /*
            name1, 2, 3에 여러분의 이름을 한 글자씩 대입하고,
            sout을 통해서 콘솔창에 여러분들 이름이 출력될 수 있도록 작성하세요.
         */
        //  1. name1, 2, 3에 수강생분들 일므은 한 글자씩 재 대입하는 과정 : 재대입시 자료형 명시하지 않음
        // 변수명 = (바뀌는)값
//        name1 = '이';
//        name2 = '진';
//        name3 = '혁';
...
//        System.out.println(width2 + width4);        // 문자열 + 정수 = 문자열로 나열 400200
//
...
//        System.out.println(dotZero);
        ...
        // 5. 상수
        // final 자료형 변수명 = 데이터
        final String FILE_PATH = "c:/leejinhyuk_java";
        // 상수의 경우에는 변수명을 대문자로 작성함.
        final String lowerCaseVariable = "소문자의 변수명";       // 오류가 나지않음 -> 1) 참조
