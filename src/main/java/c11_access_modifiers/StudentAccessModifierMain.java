...
public class StudentAccessModifierMain {
    public static void main(String[] args) {
        ...
        // setter를 통해서 데이터 입력
        student1.setStudentAvg(100);
        student1.setStudentCode(20241205);
        student1.setStudentName("이진혁");
        
        // .showInfo() 메서드를 통해서 객체 정보 출력
        student1.showInfo();

        // 새로운 객체를 student01로 생성하는데, 생성시에 이름을 "여러분이름" 으로 만들어주세요.
        // 클래스명 객체명 = new 매개변수생성자("여러분이름");
        StudentAccessModifier student01 = new StudentAccessModifier("이진혁");
        ...
        // 다하신 분들은 새로운 패키지를 만들어주세요 c12_arrays -> class ArrayTest01
    }
}
