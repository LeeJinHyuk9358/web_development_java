...
/*
    ...
    상속(inheritance)란?
        객체 지향 프로그래밍(OOP)의 핵심 개념 중 하나로 기존 클래스(부모 클래스, 슈퍼 클래스)의
        속성과 메서드를 재사용하여 새로운 클래스(자식 클래스, 서브 클래스)를 만드는 것을 의미함.
    ...
    1. 왜 상속이 필요한가
        ...
        개와 고양이는 각각 부며한 특성(예 : 짖기, 울고)을 추가할 수 있음.
    ...
    2. 상속의 특징
        ...
        3) 메서드 오버라이딩 : 자식 클래스에서 부모 클래스의 메서드를 '재정의'할 수 있음.
            이를 통해 자식 클래스는 부모 클래스의 기본 동작을 자신만의 동작으로 변경 가능
