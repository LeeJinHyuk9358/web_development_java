...
public class CentralControl {
    ...
    // 전자 제품들을 CentralControl의 객체의 필드인 배열에 추가하는 메서드 
...
//                continue;
//            }
//            System.out.println(Arrays.deepToString(deviceArray));
//        }
...
//            // 배열 내부의 요소를 하나씩 뽑게 되는 방식이 뭐였는지 떠올리셔야 됩니다.
            ...
            for(int i = 0; i < deviceArray.length; i++) {
                ...
                if (deviceArray[i] == null ) {
                    ...
                    continue;   // 현재 반복문을 종료하고 i++ 시킨 다음 반복문으로 넘어가라는 의미
                }
    ...
    public void performSpecificMethod() {
        for(Power device : deviceArray){
            if( device instanceof Computer){
                ...
                // 이제 객체명 computer는 Computer 클래스의 인스턴스이므로 Computer 클래스에 정으된
                // 고유 메서드를 실행 가능
                computer.compute();
