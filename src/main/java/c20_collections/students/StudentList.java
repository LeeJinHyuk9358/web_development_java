...
public class StudentList {
    public static void main(String[] args) {
        ...
        // 추가후에 전체 리스트를 출력하세요.
//        Student student1 = new Student(2024001,"강미경");
//        Student student2 = new Student(2024002,"강준석");
//        Student student3 = new Student(2024003,"김은수");
//        Student student4 = new Student(2024004,"박경호");
//        Student student5 = new Student(2024005,"박수빈");
...
//            if(students.get(i).getName().equals("박수빈")){
//                System.out.println(searchStr + " 학생의 학번 : " + students.get(i).getId());
//                        // 문자열을 비교하는 것이기 때문에 ==이 아니라 .equals()를 사용함
//            }
//        }
//        // 향상된 for 문
...
//        for(int i = 0; i < students.size(); i++){
//            if(students.get(i).getId() == searchInt && students.get(i).getName().equals("강준석")){
//                students.get(i).setName("박승주");
//                break;
//            }
//            System.out.println(students.get(i).getName());
//            System.out.println("학생의 이름이 박승주로 바뀌었습니다. ");
//        }
        for(Student student : students) {
        ...
        // 인덱스 넘버 이에외도 특정한 문자열을 가지고 있으면 삭제가 가능합니다. -> StringList.java 확인
        students.remove(0);
