...
public class ScoreCalculatorMain {
    public static void main(String[] args) {
        ...
        boolean endOfCalc = false;
          // 1. 기존 오버라이딩을 이용한 단순 연사잔자 사용 및 메서드 활용 예제
...
//        System.out.println("--------------------");
//        System.out.println("총 점은 " + totalScore + "점 입니다(메서드 활용)");
//        System.out.println("평균 점수는 " + avgScore + "점입니다(메서드 활용)");
...
//            System.out.println("평균 점수는 " + avgScore + "점입니다.");
