...
public class Main {
    public static void main(String[] args) {
        ...
        /*
            ...
            클래스명 객체명 = new 생성자(arguments1, argument2, ...)
            클래스1명 객체명 = new 클래스1명(new 클래스2명(), new 클래스 3명())

            이상의 경우 new 클래스2명(), new 클래스 3명()를 통해 객체 생성은 이미 완료가 되었습니다.
            다만, 여태까지와의 차이점은 new 클래스2명(), new 클래스 3명()에 해당하는 객체명이 없을 뿐입니다.
         */
        RemoteController remoteController1 = new RemoteController(new PowerButton(), new ChannelDownButton(), new ChannelUpButton(), new VolumeDownButton(), new VolumeUpButton());
