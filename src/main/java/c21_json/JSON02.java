...
public class JSON02 {
    public static void main(String[] args) {
        ...
        Gson gsonBuilder = new GsonBuilder().setPrettyPrinting().create(); // prettyPrinting을 위한 코드!! (외우는것이 좋음)
        ...
        // User 객체 선언
        User user = new User("genunsu", "1234", "maybeags@gmail.com","안근수", "37");
        ...
        jsonObject.addProperty("studentName","이진혁");
        jsonObject.addProperty("studentAge","27");
